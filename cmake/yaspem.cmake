function (yaspem_initialize_packages source_directory output_directory package_files)
...
macro (setup_yaspem)
    ...
    yaspem_initialize_packages(${SETUP_YASPEM_YASPEM_SOURCE} ${SETUP_YASPEM_OUTPUT_DIRECTORY} ${SETUP_YASPEM_PACKAGE_FILES})
    message(STATUS "")
    set (CMAKE_MODULE_PATH ${CMAKE_MODULE_PATH} ${SETUP_YASPEM_OUTPUT_DIRECTORY}/modules)
endmacro ()
